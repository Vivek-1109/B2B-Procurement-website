        ...
        {filtered.map(category => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-xs text-[#6B7280] line-clamp-2 mb-3">{category.description}</p>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-sm shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="px-6 py-4 border-b border-[#E5E7EB] flex items-center justify-between sticky top-0 bg-white z-10">
              <h2 className="font-bold text-[#1F2937]">{editing ? 'Edit Category' : 'Add New Category'}</h2>
              <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="block text-sm font-medium text-[#1F2937]">Category Image</label>
                <input
                  type="file"
      ...
      {confirmDelete && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-sm shadow-2xl p-6 max-w-sm w-full">
            <h3 className="font-bold text-[#1F2937] mb-2">Delete Category?</h3>
